document.addEventListener("DOMContentLoaded", () => {
            ...
            <ul class="participants-list">
              ${details.participants.map(email => `
                <li>
                  ...
                  <button class="delete-btn" onclick="removeParticipant('${name}', '${email}')" title="Remove participant">🗑️</button>
                </li>
              `).join('')}
            </ul>
          `;
  ...
  // Make removeParticipant globally accessible for onclick handlers
